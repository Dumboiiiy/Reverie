...
import { BRANDS } from "@/features/admin/products/constant";
import type {
  Category,
  Product,
  ProductStatus,
} from "@/features/admin/products/types";
import { ColorPicker } from "./basics/color-picker";
import { SizeSelector } from "./basics/size-selector";
import { ImagePicker } from "./basics/image-picker";
